...
<html>
    <head>
        ...
        <%  // variable declaration & initializing
             ...
             * request 객체의 parameter 변수 variable에 저장된 변수를 얻어내는 method
             * return 값 = String 
             * 처음 접속 시 11번 record부터 30개 record 출력 처리*/
            int fromPT = request.getParameter("from") == null ? 10 : Integer.parseInt(request.getParameter("from"));
            int cntPT = request.getParameter("cnt") == null ? 30 : Integer.parseInt(request.getParameter("cnt"));
        %>
